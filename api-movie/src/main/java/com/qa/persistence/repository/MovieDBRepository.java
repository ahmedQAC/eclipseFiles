...
@Transactional(SUPPORTS) //means that you make all methods @Transactional(REQUIRED)
@Default
public class MovieDBRepository implements MovieRepository{
	
	@PersistenceContext(unitName = "primary")
	private EntityManager manager; //Creating our manager.
	...
	public String getAllMovies() {
		Query query = manager.createQuery("Select a FROM Movie a"); //Creating a manager and telling it to get a collection of the movies.
